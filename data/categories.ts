...
export const categories: Array<ICategories> = [
  {
    ...
    description:
      "افکار خودکشی میتونه ترسناک و گیج­‌کننده باشه. اگر نگران خودتون یا یکی از اطرافیانتون هستین بهتره قبل از هر کاری با یه نفر صحبت کنین. همه‌ی سرویس‌ها رایگان هستند و هیچ درخواستی برای افشای هویت شما نمی کنند و تمامی اطلاعات و حرف های شما، محرمانه است",
    resources: [
      {
  ...
  },
  {
    ...
    resources: [
      {
        title: "لیست مراکز آزمایش رایگان ایدز و مشاوره بیماری های رفتاری",
        description:
          "در این مراکز علاوه بر مشاوره، آزمایش ایدز و تشخیص HIV به صورت رایگان انجام می‌شود.",
        website: "/free-hiv-test-centers",
      },
      {
