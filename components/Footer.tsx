...
export default function Footer() {
  ...
  return (
    <footer className='text-brand-footer mt-auto p-4 pt-8 text-center text-xs font-normal text-gray-500 sm:p-5 sm:pt-12'>
      <p className='pb-6 text-right text-xs leading-relaxed sm:text-sm'>
      ...
      <p className='border-b border-[#d2d2d7] pb-3 text-right text-xs leading-relaxed sm:text-sm'>
        این یک{' '}
      ...
      <p className='mb-2 pt-6 text-xs leading-relaxed sm:text-sm'>
